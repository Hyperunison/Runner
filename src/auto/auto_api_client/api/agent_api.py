...
class AgentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.export_cdm_quantexa_reference_code_csv_endpoint = _Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [],
                'endpoint_path': '/api/agent/v{version}/{token}/{cdmId}/cdm-quantexa-reference-code/export',
                'operation_id': 'export_cdm_quantexa_reference_code_csv',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.export_cdm_values_csv_endpoint = _Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [],
                'endpoint_path': '/api/agent/v{version}/{token}/{cdmId}/cdm-values/export',
                'operation_id': 'export_cdm_values_csv',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.export_cdm_vocabulary_csv_endpoint = _Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [],
                'endpoint_path': '/api/agent/v{version}/{token}/{cdmId}/cdm-vocabulary/export',
                'operation_id': 'export_cdm_vocabulary_csv',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.export_docs_for_specific_biobank_endpoint = _Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [],
                'endpoint_path': '/api/agent/v{version}/{token}/export-mapping/docs',
                'operation_id': 'export_docs_for_specific_biobank',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.export_docs_for_specific_biobank_in_csv_format_endpoint = _Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [],
                'endpoint_path': '/api/agent/v{version}/{token}/export-mapping/docs/csv',
                'operation_id': 'export_docs_for_specific_biobank_in_csv_format',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.post_app_agent_addjoblogs_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/api/agent/v{version}/{token}/job/runner-message/{runId}/add-logs',
                'operation_id': 'post_app_agent_addjoblogs',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    ...
                    'token',
                    'run_id',
                    'post_app_agent_addjoblogs_request',
                ],
                'required': [
                    'version',
                    'token',
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'token': 'path',
                    'run_id': 'path',
                    'post_app_agent_addjoblogs_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.set_cte_materialization_status_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
                'endpoint_path': '/api/agent/v{version}/{token}/cte-materialization-status',
                'operation_id': 'set_cte_materialization_status',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'version',
                    'token',
                    'set_cte_materialization_status_request',
                ],
                'required': [
                    'version',
                    'token',
            ...
            root_map={
                ...
                'openapi_types': {
                    ...
                    'token':
                        (str,),
                    'set_cte_materialization_status_request':
                        (SetCteMaterializationStatusRequest,),
                },
                'attribute_map': {
                    'version': 'version',
                    'token': 'token',
                ...
                'location_map': {
                    'version': 'path',
                    'token': 'path',
                    'set_cte_materialization_status_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.set_installed_pipelines_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
                'endpoint_path': '/api/agent/v{version}/{token}/pipelines/installed/',
                'operation_id': 'set_installed_pipelines',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'version',
                    'token',
                    'set_installed_pipelines_request',
                ],
                'required': [
                    'version',
                    'token',
            ...
            root_map={
                ...
                'location_map': {
                    'version': 'path',
                    'token': 'path',
                    'set_installed_pipelines_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.set_run_dir_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
                'endpoint_path': '/api/agent/v{version}/{token}/run/{id}/dir',
                'operation_id': 'set_run_dir',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def export_cdm_quantexa_reference_code_csv(
        self,
        version,
        token,
        cdm_id,
        **kwargs
        ...
        """export_cdm_quantexa_reference_code_csv  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.export_cdm_quantexa_reference_code_csv(version, token, cdm_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['cdm_id'] = \
            cdm_id
        return self.export_cdm_quantexa_reference_code_csv_endpoint.call_with_http_info(**kwargs)

    def export_cdm_values_csv(
        self,
        version,
        token,
        cdm_id,
        **kwargs
        ...
        """export_cdm_values_csv  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.export_cdm_values_csv(version, token, cdm_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['cdm_id'] = \
            cdm_id
        return self.export_cdm_values_csv_endpoint.call_with_http_info(**kwargs)

    def export_cdm_vocabulary_csv(
        self,
        version,
        token,
        cdm_id,
        **kwargs
        ...
        """export_cdm_vocabulary_csv  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.export_cdm_vocabulary_csv(version, token, cdm_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['cdm_id'] = \
            cdm_id
        return self.export_cdm_vocabulary_csv_endpoint.call_with_http_info(**kwargs)

    def export_docs_for_specific_biobank(
        self,
        version,
        token,
        **kwargs
    ):
        """export_docs_for_specific_biobank  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.export_docs_for_specific_biobank(version, token, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['token'] = \
            token
        return self.export_docs_for_specific_biobank_endpoint.call_with_http_info(**kwargs)

    def export_docs_for_specific_biobank_in_csv_format(
        self,
        version,
        token,
        **kwargs
    ):
        """export_docs_for_specific_biobank_in_csv_format  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.export_docs_for_specific_biobank_in_csv_format(version, token, async_req=True)
        >>> result = thread.get()
    ...
    def export_mapping_short_for_specific_biobank(
        ...
        **kwargs
        ...
        """export_mapping_short_for_specific_biobank  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.export_mapping_short_for_specific_biobank(version, token, async_req=True)
        >>> result = thread.get()
    ...
    def post_app_agent_addjoblogs(
        ...
        **kwargs
        ...
        """post_app_agent_addjoblogs  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_app_agent_addjoblogs(version, token, run_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            post_app_agent_addjoblogs_request (PostAppAgentAddjoblogsRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['run_id'] = \
            run_id
        return self.post_app_agent_addjoblogs_endpoint.call_with_http_info(**kwargs)
    ...
    def set_cte_materialization_status(
        self,
        version,
        token,
        **kwargs
    ):
        """set_cte_materialization_status  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.set_cte_materialization_status(version, token, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            set_cte_materialization_status_request (SetCteMaterializationStatusRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['token'] = \
            token
        return self.set_cte_materialization_status_endpoint.call_with_http_info(**kwargs)
    ...
    def set_installed_pipelines(
        self,
        version,
        token,
        **kwargs
    ):
        """set_installed_pipelines  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.set_installed_pipelines(version, token, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            set_installed_pipelines_request (SetInstalledPipelinesRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['token'] = \
            token
        return self.set_installed_pipelines_endpoint.call_with_http_info(**kwargs)
    ...
    def set_run_dir(
        ...
        **kwargs
        ...
        """set_run_dir  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.set_run_dir(id, version, token, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            set_run_dir_request (SetRunDirRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['token'] = \
            token
        return self.set_run_dir_endpoint.call_with_http_info(**kwargs)
